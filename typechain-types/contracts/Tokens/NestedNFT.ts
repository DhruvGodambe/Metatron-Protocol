...
export interface NestedNFTInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "VoucherRedeemed(address,uint256)": EventFragment;
  };
...
export interface NestedNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NestedNFTInterface;
  ...
  filters: {
    ...
    "VoucherRedeemed(address,uint256)"(
      _user?: null,
      _value?: null
    ): VoucherRedeemedEventFilter;
    VoucherRedeemed(_user?: null, _value?: null): VoucherRedeemedEventFilter;
  };

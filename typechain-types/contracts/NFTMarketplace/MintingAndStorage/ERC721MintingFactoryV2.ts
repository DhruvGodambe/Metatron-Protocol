...
export interface ERC721MintingFactoryV2Interface extends utils.Interface {
  functions: {
...
export interface ERC721MintingFactoryV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721MintingFactoryV2Interface;

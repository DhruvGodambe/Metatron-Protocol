...
export interface AltERC721MintingFactoryInterface extends utils.Interface {
  functions: {
...
export interface AltERC721MintingFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AltERC721MintingFactoryInterface;

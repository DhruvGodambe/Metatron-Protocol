...
export interface NFTCollectionInterface extends utils.Interface {
  functions: {
    ...
    "mintNewNFT(string)": FunctionFragment;
    "mintingFactory()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintingFactory",
    values?: undefined
  ): string;
...
export interface NFTCollection extends BaseContract {
  ...
  functions: {
    ...
    mintingFactory(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    mintingFactory(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    mintingFactory(overrides?: CallOverrides): Promise<PopulatedTransaction>;

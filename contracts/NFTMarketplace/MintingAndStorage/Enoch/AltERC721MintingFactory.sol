...
import "./AltERC721NFTContract.sol";

contract AltERC721MintingFactory {
        ...
        returns (address _nftcontract)
    {
        ...
        address nftContract = address(
            new AltERC721NFTContract(_name, _symbol, msg.sender)
        );
    ...
    {
        AltERC721NFTContract(_nftContract).mintNewNFT(_tokenURI);
        uint256 _tokenId = AltERC721NFTContract(_nftContract).getTotalNFTs();
    ...
    function getTotalNFTsMinted(address _nftContract)
        ...
        returns (uint256)
    {
        return AltERC721NFTContract(_nftContract).getTotalNFTs();
    }
}
